...
import Timer from './src/assignment/timer/Timer';
...
import ToDo from './src/assignment/todo/ToDo';
...
import TodouseReducer from './src/hooks/TodouseReducer';
          ...
          headerRight: () => (
            <Button
              ...
              onPress={() => {
                ...
                parent?.reset({
                  index: 0,
                  routes: [{ name: 'LazyLoading' }],
                });
              }}
            />
          ),
        })}
        initialRouteName="TodouseReducer"
      >
        <Debounce.Screen name="TodouseReducer" component={TodouseReducer} />
        <Drawer.Screen name="useImperativeHandle" component={ParentComponent} />
      </Debounce.Navigator>
    );
  }
